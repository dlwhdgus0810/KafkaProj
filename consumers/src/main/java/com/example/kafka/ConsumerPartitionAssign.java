...
public class ConsumerPartitionAssign {
    ...
    private static final Logger log = LoggerFactory.getLogger(ConsumerPartitionAssign.class.getName());
    ...
    public static void main(String[] args) {
        ...
        KafkaConsumer<String, String> kafkaConsumer = createConsumer("group_pizza_assign_seek");
